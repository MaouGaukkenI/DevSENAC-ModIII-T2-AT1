...
public class GuiJTableBuscaPaciente extends javax.swing.JInternalFrame {
    ...
    DefaultTableModel dtm = new DefaultTableModel(
            new Object[][]{},
            new Object[]{"Código", "Nome", "CPF", "Data de Nascimento", "Endereço", "Telefone", "E-mail", "Convênio"});
    ...
    private void initComponents() {
        ...
        jtablePaciente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CPF", "Data de nascimento", "Endereço", "Telefone", "E-mail", "Convênio"
            }
        ));
        ...
        jScrollPane1.setBounds(30, 20, 580, 180);
        ...
        jlFiltro.setBounds(440, 20, 120, 16);
        ...
        jtFiltro.setBounds(440, 40, 170, 40);
    ...
    private boolean limparFiltro() {
        jtFiltro.setText("");
        String txt = jtFiltro.getText();
        if ("".equals(txt)) {
            return true;
        } else {
            return false;
