...
public class PacienteDAO {
    ...
    public boolean cadastrarPaciente(Paciente pac) throws SQLException {
        //Considerando o fato que a tabela convenio no BD possui auto Increament ele nunca tera valores negativos.
        if(pac.getDataNascimento() != null && pac.getConvenio() > 0 && !"".equals(pac.getCpf()) && !"".equals(pac.getEndereco()) && !"".equals(pac.getNome()) && !"".equals(pac.getTelefone())){
            try {
                ...
                String sql = "insert into PACIENTE(NOME, ENDERECO, DATA_NASC, TELEFONE, `E-MAIL`, CPF, ID_CONVENIO_FK) values(?,?,?,?,?,?,?)";
        ...
        try {
           ...
           banco de dados o while roda */
            while (rs.next()) {
                ...
                pac.setEmail(rs.getString("E-MAIL"));
